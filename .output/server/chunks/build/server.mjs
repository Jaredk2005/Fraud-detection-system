...
const _routes = [
  {
    ...
    component: () => import('./index-DS9d9FyU.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-Bvtcj3WK.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    meta: { "middleware": "auth" },
    component: () => import('./reports-Cv6gk89n.mjs')
  },
  {
    name: "analysis",
    path: "/analysis",
    meta: { "middleware": "auth" },
    component: () => import('./analysis-CFNBQB_5.mjs')
  },
  {
    name: "training",
    path: "/training",
    meta: { "middleware": "auth" },
    component: () => import('./training-CKDkfTRN.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./dashboard-C89aGOKY.mjs')
  },
  {
    name: "prediction",
    path: "/prediction",
    meta: { "middleware": "auth" },
    component: () => import('./prediction-C2v0vQ__.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-1xYuTciz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cz13IZ4i.mjs'));
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, useRoute as c, appLayoutTransition as d, entry$1 as default, _wrapInTransition as e, defineNuxtRouteMiddleware as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
