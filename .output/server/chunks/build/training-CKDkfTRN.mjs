        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!unref(selectedFile)) {
              _push2(`<div class="cursor-pointer" data-v-ae4b8bd4${_scopeId}><div class="text-4xl text-gray-400 mb-2" data-v-ae4b8bd4${_scopeId}>\u{1F4C4}</div><p class="text-gray-300" data-v-ae4b8bd4${_scopeId}>Click to select a CSV file</p><p class="text-sm text-gray-500 mt-1" data-v-ae4b8bd4${_scopeId}>File must contain &#39;is_fraud&#39; column</p></div>`);
            } else {
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("div", { class: "border-2 border-dashed border-gray-600 rounded-lg p-6 text-center" }, [
                      ...
                      !unref(selectedFile) ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "text-4xl text-gray-400 mb-2" }, "\u{1F4C4}"),
...
//# sourceMappingURL=training-CKDkfTRN.mjs.map
