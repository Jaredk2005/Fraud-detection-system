...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Advanced credit card fraud detection and prevention system"}],"link":[],"style":[],"script":[],"noscript":[],"title":"FraudGuard - Credit Card Fraud Detection"};
